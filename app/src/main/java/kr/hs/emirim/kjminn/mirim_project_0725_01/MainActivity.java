package kr.hs.emirim.kjminn.mirim_project_0725_01;
    ...
    public static class MyFragment extends Fragment{
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            if(tabName.equals("박하나")){
                ...
                imgV.setImageResource(R.drawable.parkhana);
            }
            if(tabName.equals("임수향")){
                layout.setBackgroundColor(Color.YELLOW);
                imgV.setImageResource(R.drawable.limsuhang);
            }
            if(tabName.equals("방성훈")){
                layout.setBackgroundColor(Color.BLUE);
                imgV.setImageResource(R.drawable.sunghoon);
            }
